    ...
    ptbr: {
        ...
        resume : {
            ...
            cover_letter: {
                ...
                description: {
                    paragraphs: [
                        'Sou apaixonado por ajudar as pessoas e o que me move é o desafio, tanto na minha vida profissional quanto pessoal. Sou formado em Análise e Desenvolvimento de Sistemas e recentemente concluí um MBA em Gestão de TI, o que aprimorou ainda mais meus conhecimentos em ITIL e COBIT. Com mais de 11 anos de experiência em desenvolvimento de software, adquiri excelentes conhecimentos em linguagens de programação PHP, Java e Javascript e banco de dados MySQL / MSSQL. Também pude desenvolver meus conhecimentos em modelagem de banco de dados e dados. Atualmente trabalho na área de TI da empresa brasileira “PROCERGS”.',
    ...
    en: {
        ...
        resume : {
            ...
            cover_letter: {
                ...
                description: {
                    paragraphs: [
                        'I love to help people and I am moved by challenge. I have an Associates degree in Analysis and System Development and an MBA degree in IT Management, which further improved my knowledge in ITIL and COBIT. Through my eleven years of experience in software development, I acquired an excellent knowledge in PHP, Java and Javascript programming languages and MySQL/MSSQL database. I was also able to develop my knowledge in database and data modeling. I am currently working in the IT area of the Brazilian company “PROCERGS”. ',
